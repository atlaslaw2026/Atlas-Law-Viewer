...
def test_is_allowed_pdf_target_rejects_non_cacd_law_justia_path():
    target = urlparse(
        "https://law.justia.com/cases/federal/district-courts/new-york/nysdce/1:2026cv00001/"
    )
...
def test_cloudflare_challenge_detector():
    payload = (
        "Just a moment... Please enable JavaScript to continue. https://challenges.cloudflare.com"
    )
